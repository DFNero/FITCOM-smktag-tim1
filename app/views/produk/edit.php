...
<style>
body { font-family: Tahoma, sans-serif; background: linear-gradient(135deg, #4fc29eff, #9fbbd8ff); min-height: 100vh;
...
.btn-cancel:hover { background: #edf2f7; color: black !important; }
...
<!-- Icon Theme di pojok kanan -->
<span class="nav-link text-white position-absolute top-0 end-0 m-3" id="darkModeToggle">
  <span id="themeIcon">
    <!-- moon -->
    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" 
      class="bi bi-moon-fill" viewBox="0 0 16 16">
      <path d="M6 .278a.77.77 0 0 1 .08.858 
        7.2 7.2 0 0 0-.878 3.46c0 4.021 
        3.278 7.277 7.318 7.277q.792-.001 
        1.533-.16a.79.79 0 0 1 .81.316.73.73 
        0 0 1-.031.893A8.35 8.35 0 0 1 
        8.344 16C3.734 16 0 12.286 0 7.71 
        0 4.266 2.114 1.312 5.124.06A.75.75 
        0 0 1 6 .278"/>
    </svg>
  </span>
</span>
...
<div class="card shadow-lg p-4" style="max-width: 550px; width: 100%;">
  <div class="card-header text-center bg-transparent border-0 mb-3">
    <h3 class="fw-bold text-success d-inline-flex align-items-center justify-content-center">
      <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" fill="currentColor" 
        ...
        <path d="M13.752 4.396l-2-2L4.939 9.21a.5.5 
                0 0 0-.121.196l-.805 2.414a.25.25 
                0 0 0 .316.316l2.414-.805a.5.5 
                0 0 0 .196-.12l6.813-6.814z"/>
        <path fill-rule="evenodd" d="M1 13.5A1.5 1.5 0 0 0 
                2.5 15h11a1.5 1.5 0 0 0 1.5-1.5v-6a.5.5 
  ...
  <form method="POST" enctype="multipart/form-data">
    ...
    <div class="d-flex justify-content-between mt-4">
      ...
      <button type="submit" class="btn btn-update btn-custom px-4 d-flex align-items-center justify-content-center gap-2">
